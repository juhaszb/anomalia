...
PYBIND11_MODULE(parser, m)
{
	...
	py::register_exception<ciff_exception>(m, "ciff_exception");
	py::register_exception<magic_exception>(m, "magic_exception");
	py::register_exception<parse_failed>(m, "parse_failed");
